const resumeData = {
  main: {
    ...
    website: "www.theshifaligwal.com",
  },
  resume: {
    ...
    education: [
      {
        ...
        description: "Graduated with --% Aggregate",
      },
    ],
    work: [
      {
      ...
      },
      {
        ...
        techStack: [
          ...
          },
          {
            ...
            width: "64",
            iconLink:
              "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Braintree_logo.svg/220px-Braintree_logo.svg.png",
          },
        ],
      },
    ],
